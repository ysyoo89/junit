...
class ProfileTest {
    ...
    public void findsAnswersBasedOnPredicate() {
        ...
        List<Answer> answersComplement = profile.getAnswers().find(a -> a.getQuestion().getClass() != PercentileQuestion.class);
    ...
    public void findAnswers() {
        ...
        long elapsedMs = run(numberOfTimes, () -> profile.getAnswers().find(a -> a.getQuestion().getClass() == PercentileQuestion.class));
